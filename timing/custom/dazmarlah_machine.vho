...
SIGNAL \temp[1]~combout\ : std_logic;
SIGNAL \temp[2]~combout\ : std_logic;
SIGNAL \fifty_in~combout\ : std_logic;
SIGNAL \hund_in~combout\ : std_logic;
SIGNAL \temp[0]~combout\ : std_logic;
...
-- Equation(s):
-- \Selector2~0_combout\ = (!\temp[2]~combout\ & (\temp[1]~combout\ & (!\temp[0]~combout\ & \present_st.state_2~regout\)))
...
-- Equation(s):
-- \next_state.state_8~0_combout\ = (\temp[2]~combout\ & (!\temp[1]~combout\ & (\temp[0]~combout\ & \present_st.state_3~regout\)))
...
-- Equation(s):
-- \next_state.state_7~0_combout\ = (\temp[2]~combout\ & (!\temp[1]~combout\ & (!\temp[0]~combout\ & \present_st.state_3~regout\)))
...
-- Equation(s):
-- \Selector0~1_combout\ = (\temp[2]~combout\ & ((\present_st.state_2~regout\) # ((\temp[1]~combout\ & \temp[0]~combout\)))) # (!\temp[2]~combout\ & (\temp[1]~combout\ & (\temp[0]~combout\ & \present_st.state_2~regout\)))
...
-- Equation(s):
-- \next_state.state_4~0_combout\ = (!\temp[1]~combout\ & (!\temp[2]~combout\ & \present_st.state_2~regout\))
...
-- Equation(s):
-- \next_state.state_6~0_combout\ = (!\temp[2]~combout\ & \present_st.state_3~regout\)
...
-- Equation(s):
-- \next_state.state_9~0_combout\ = (\temp[2]~combout\ & (\temp[1]~combout\ & (!\temp[0]~combout\ & \present_st.state_3~regout\)))
